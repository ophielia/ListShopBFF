...
public final class SkieSwiftMutableSharedFlow<T> : allshared.SkieSwiftFlowProtocol,
    ...
    public static func _forceBridgeFromObjectiveC(_ source: allshared.SkieKotlinMutableSharedFlow<Swift.AnyObject>, result: inout allshared.SkieSwiftMutableSharedFlow<T>?) -> Swift.Void {
    ...
    public func _bridgeToObjectiveC() -> allshared.SkieKotlinMutableSharedFlow<Swift.AnyObject> {
        return allshared.SkieKotlinMutableSharedFlow(delegate)
    }

    private static func fromObjectiveC(_ source: allshared.SkieKotlinMutableSharedFlow<Swift.AnyObject>?) -> Self {
        guard let source = source else {
            fatalError("Couldn't map value of \(Swift.String(describing: source)) to allshared.SkieSwiftMutableSharedFlow")
        }
