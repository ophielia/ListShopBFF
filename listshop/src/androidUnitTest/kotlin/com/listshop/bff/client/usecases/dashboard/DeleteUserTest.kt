...
class DeleteUserTest {
    ...
    @Test
    fun `when i delete a user, the api calls are made`(): Unit = runBlocking {
    ...
    @Test
    fun `when i delete a user which is not logged in, the call fails`(): Unit = runBlocking {
        // setup database / context
        initializeContext()
    ...
    @Test
    fun `when i delete a user while offline, the call fails`(): Unit = runBlocking {
        // setup database / context
        initializeContext()
    ...
    @Test
    fun `when i delete a user, the session is cleared`(): Unit = runBlocking {
        // setup database / context
        initializeContext()
        val loggedInUser = databaseTestHelper?.standardUser()
        databaseTestHelper?.setUser(loggedInUser)
